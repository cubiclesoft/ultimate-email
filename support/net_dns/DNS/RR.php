...
/* Include files {{{ */
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/A.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/AAAA.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/NS.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/CNAME.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/PTR.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/SOA.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/MX.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/TSIG.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/TXT.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/HINFO.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/SRV.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/NAPTR.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/RP.php");
require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR/SPF.php");
/* }}} */
