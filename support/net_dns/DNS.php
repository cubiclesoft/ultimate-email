...
/* Include information {{{ */
    ...
    require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/Header.php");
    require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/Question.php");
    require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/Packet.php");
    require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/Resolver.php");
    require_once(CS_EMAIL_ROOT_PATH . "/net_dns/DNS/RR.php");
